...
>(({ className, alt, src, ...props }, ref) => (
    ...
    >
        ...
        /> */}
        <div className="max-w-lg mx-auto"> {/* Contenedor para controlar el tamaño */}
            {/* 2. Usa la etiqueta <img> estándar */}
            <img
                src={src} // La variable importada va aquí
                alt={alt}
                className="absolute inset-0 size-full rounded-[16px] object-cover" // Clases de Tailwind para responsividad y estilo
            />
        </div>
